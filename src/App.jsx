  ...
  return (
    <div className="min-h-screen bg-[#f3f4f6] p-2 md:p-6 text-slate-900 print:bg-white print:p-0">
      ...
      <main className="max-w-[1200px] mx-auto">
        {error && (
          <div className="mb-4 p-4 bg-red-50 text-red-600 rounded-2xl text-xs font-bold flex items-center gap-2 border border-red-100 animate-in fade-in print:hidden">
